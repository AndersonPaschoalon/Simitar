...
class GnuplotScripts:
    def __init__(self, plot_dir='', data_dir='', font='Helvetica,10', xlabel='xlabel', ylabel='ylabel', title='title',
                 ...
                 legend1='', legend2='', legend3='', legend4='', line_width='2', type='lines'):
...
if __name__ == "__main__":
    ...
    gp.plot_config(legend1='curve1', legend2='curve2', title='', ylabel='y values', xlabel='x values', type='linespoints', linestyle_1='r+', linestyle_2='vx')
