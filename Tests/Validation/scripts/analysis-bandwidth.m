...
SCALE = str2num(arg_list{4});
SCALE_STR = arg_list{4};
...
% Save data
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Bandwidth_Data = [timeVector1 bandwidthVector1/SCALE bandwidthVector2/SCALE];

title = strcat ('Bandwidth (bits/scale),  scale:',  SCALE_STR);
labels = 'time(x)(seconds), bitRate1(y)(bits), bitRate2(y)(bits)';
filename = strcat(DATA_DIR, 'Bandwidth', PLOT_DATA_EXT);
