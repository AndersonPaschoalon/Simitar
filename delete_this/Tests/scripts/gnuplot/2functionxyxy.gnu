...
if (!exists("datafile")) datafile='../../plots/default/2function.dat'
...
if (!exists("type")) type = 'points-lines'
if (!exists("lw")) lw = '2'
...
if( type eq 'points-points') \
	plot datafile using 1:2 with points ls linestyle1  title legend1, \
	datafile using 3:4 with points ls linestyle2  title legend2
if( type eq 'points-lines') \
	plot datafile using 1:2 with points ls linestyle1  title legend1, \
	datafile using 3:4 with lines ls linestyle2  title legend2
if( type eq 'linespoints') \
	...
	datafile using 3:4 with linespoints ls linestyle2  title legend2
if( type eq 'lines-lines') \
	plot datafile using 1:2 with lines ls linestyle1  title legend1, \
	datafile using 3:4 with lines ls linestyle2  title legend2
if( type eq 'lines-points') \
	plot datafile using 1:2 with lines ls linestyle1  title legend1, \
	datafile using 3:4 with points ls linestyle2  title legend2
