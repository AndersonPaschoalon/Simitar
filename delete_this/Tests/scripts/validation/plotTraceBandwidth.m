...
%
% Usage example:
% ./plotTraceBandwidth.m  "sim1_live_background-traffic-1"  "wireshark-wiki_SkypeIRC" "5"
%
...
[timeVector1 bandwidthVector1] = traceBandwidth(vetDepertureTimes1, vetPacketSizes1, sample_size);
[timeVector2 bandwidthVector2] = traceBandwidth(vetDepertureTimes2, vetPacketSizes2, sample_size);
