...
class Sniffer:
    def __init__(self, captureMethod='none', captureTarget='none', liveTimeout=10, traceID=0, logfile_path='.'):
        """
        ...
        self.logfile_path_prefix = logfile_path + '/sniffer-'
    ...
    def start(self, verbose=True):
        ...
        set_logformat = '[%(levelname)s] (%(threadName)-10s) %(message)s'
        # init
        ...
        if capture_method == 'live':
            ...
            logging.basicConfig(filename=file_log_name, format=set_logformat, level=set_loglevel)
            # capture
...
if __name__ == '__main__':
    theSniffer = Sniffer(captureMethod='live', captureTarget='wlp6s0', liveTimeout=3, traceID=0)
