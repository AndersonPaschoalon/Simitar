...
if (!exists("datafile1")) datafile1 ='../../plots/default/2function.dat'
if (!exists("datafile2")) datafile2 ='../../plots/default/3function.dat'
...
set logscale x 10
if( type eq 'points') \
	plot datafile1 using ($1 == 0 ? Nan : $1):2  with points ls linestyle1  title legend1, \
	datafile2 using ($1 == 0 ? Nan : $1):2 with points ls linestyle2  title legend2
if( type eq 'linespoints') \
	plot datafile1 using ($1 == 0 ? Nan : $1):2 with lines ls linestyle1 title legend1, \
	datafile1 using ($1 == 0 ? Nan : $1):2 with points ls linestyle1, \
	datafile2 using ($1 == 0 ? Nan : $1):2 with linespoints ls linestyle2  title legend2
if( type eq 'lines') \
	plot datafile1 using 1:2 with lines ls linestyle1  title legend1, \
	datafile2 using 1:2  with lines ls linestyle2  title legend2
