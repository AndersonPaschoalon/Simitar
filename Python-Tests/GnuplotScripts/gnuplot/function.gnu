...
if (!exists("datafile")) datafile='../../plots/default/function.dat'
...
if (!exists("linestyle")) linestyle = '12'
...
if( type eq 'points') plot datafile using 1:2 with points ls linestyle
if( type eq 'linespoints') plot datafile using 1:2 with linespoints ls linestyle 
if( type eq 'lines') plot datafile using 1:2 with lines ls linestyle
