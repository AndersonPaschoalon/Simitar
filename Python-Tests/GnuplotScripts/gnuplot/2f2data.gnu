...
if( type eq 'points') \
	plot datafile1 using 1:2 with points ls linestyle1  title legend1, \
	datafile2 using 1:2 with points ls linestyle2  title legend2
if( type eq 'linespoints') \
	plot datafile1 using 1:2 with lines ls linestyle1 title legend1, \
	datafile1 using 1:2 with points ls linestyle1, \
	datafile2 using 1:2 with linespoints ls linestyle2  title legend2
if( type eq 'lines') \
	plot datafile1 using 1:2 with lines ls linestyle1  title legend1, \
